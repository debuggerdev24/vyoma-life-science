      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Image
                ...
                alt="VyomaLife"
              />
              <span className="text-lg font-semibold">VyomaLife</span>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed mb-4">
              High-performance products developed for safe, sustainable, 
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><Link href="#">MTK+ – Vitaminozulty</Link></li>
              <li><Link href="#">AG40 – Growth Enhancer</Link></li>
              <li><Link href="#">JNV – Growth Promoter</Link></li>
              <li><Link href="#">BUDINA – Plant Care</Link></li>
            </ul>
          </div>
